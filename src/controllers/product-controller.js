...
exports.post = async(req, res, next) => {
  ...
  contract.hasMinLen(req.body.description, 10, 'A descrição deve conter no mínimo 10 caracteres');
  ...
  try {
    ...
    await repository.create({
      ...
      active: true,
      tags: req.body.tags,
      image: 'https://imagesnodestore.blob.core.windows.net/product-images/' + filename
    });
    res.status(201).send({
